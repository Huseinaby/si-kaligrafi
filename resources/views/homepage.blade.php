...
<div class="content">
    <h2>KALIGRAFI</h2>
    <h3>Pembuatan</h3>
    <p class="textutama"> Percantik masjid Anda dengan sentuhan seni kaligrafi islami dari kami <br> dan rasakan
        keindahan
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Dengan pengalaman bertahun-tahun dalam seni kaligrafi masjid, kami memiliki
                            keahlian untuk menciptakan karya yang memukau dan sesuai dengan harapan Anda.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Didukung oleh tenaga ahli yang terlatih dan berkompeten, kami menjamin
                            setiap detail kaligrafi masjid Anda ditangani dengan ketelitian dan dedikasi tinggi.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
